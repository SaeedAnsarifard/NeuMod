...
def calculate_day_length(days_since_start, lat=75):
    """
...
def main():
    ...
    # Save to a text file
    np.savetxt('./Data/time_exposures_3.txt', organized_data, fmt='   '.join(['%i'] + ['%.1f']*3), header='num_bin  t_k  T_k^day  T_k^night')
